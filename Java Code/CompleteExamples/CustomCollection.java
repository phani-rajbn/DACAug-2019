...
class Apple implements Iterable<Apple>{
	//All collection classes are having the method called iterator which 
	Iterator<Apple> iterator(){
		
	}
	//foreach is forward only and read only. It is move over one item at a time only. 
	//Will have all the features
	//U should make the object of this class usable in a foreach...
}
class Book{
	@Override
